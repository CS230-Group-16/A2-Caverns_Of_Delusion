...
public class Board {
	...
	int[] getPlayerLocation(int player) {
		if(player == 1) {return player1Location;}
		if(player == 2) {return player2Location;}
		if(player == 3) {return player3Location;}
		if(player == 4) {return player4Location;}
	...
	void updatePlayerLocation(int player, int[] newLocation) {
		if(player == 1) {player1Location = newLocation;}
		if(player == 2) {player2Location = newLocation;}
		if(player == 3) {player3Location = newLocation;}
		if(player == 4) {player4Location = newLocation;}
	}
